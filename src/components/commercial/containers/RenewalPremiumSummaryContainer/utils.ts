...
export const sortSummaries = (summaries: AppTypes.RenewalPremiumSummaryManifestEntry[], order: string) => {
...
export const filterPastRenewals = (summaries: AppTypes.RenewalPremiumSummaryManifestEntry[], showPastRenewals: boolean) =>
